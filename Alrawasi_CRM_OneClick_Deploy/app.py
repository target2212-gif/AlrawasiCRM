...
# Render Free: there is no Persistent Disk. The runtime DB lives in /app
# and is reconstructed from the refined seed chunks by free_seed_bootstrap.py
# before Gunicorn starts.
IS_RENDER=bool(os.environ.get('RENDER') or os.environ.get('RENDER_SERVICE_ID'))
DATA_DIR=BASE
DB=SEED_DB
DATA_LOCK=os.path.join(BASE,'.alrawasi_data_initialized')
