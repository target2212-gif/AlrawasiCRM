...
def companies():
 ...
 elif cls in ('5','4','3','2','1'):
  grade_words={'5':'خامس','4':'رابع','3':'ثالث','2':'ثان','1':'أول'}
 ...
 WHEN c.classification_grade='5' OR c.classification_grade LIKE '%خامس%' THEN 2
 WHEN c.classification_grade='4' OR c.classification_grade LIKE '%رابع%' THEN 3
 WHEN c.classification_grade='3' OR c.classification_grade LIKE '%ثالث%' THEN 4
 WHEN c.classification_grade='2' OR c.classification_grade LIKE '%ثان%' THEN 5
 WHEN c.classification_grade='1' OR c.classification_grade LIKE '%أول%' THEN 6
 ELSE 7 END, c.id LIMIT ? OFFSET ?"""
